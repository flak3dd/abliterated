...
export function sanitizeSettings(stored?: Partial<ClientSettings>): ClientSettings {
  ...
  const result: ClientSettings = {
    ...
    mempalaceSelfLearning: s.mempalaceSelfLearning !== false,
    mempalaceAntiPatternMining: s.mempalaceAntiPatternMining !== false,
    mempalaceSalienceDecay: s.mempalaceSalienceDecay !== false,
