...
4. Implement the smallest diff that meets the goal; one concern per edit batch.
5. Verify with the project build/test commands (e.g. npm run build / tsc) and re-read changed files if checks fail.
