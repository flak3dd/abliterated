...
| **Starter** | **$24.99/mo** | 1 workspace, 1 MCP, Jobs concurrency **1**, built-in unrestricted model **1M tokens/mo**, watermark |
| **Pro** | **$49.99/mo** or **$349/yr** | Unlimited MCP, Jobs concurrency **up to 4**, **Plan mode**, built-in unrestricted model **3M tokens/mo**, no watermark |
| **Team** | **$99/mo per seat** | Everything in Pro + shared seats + built-in unrestricted model **5M tokens/mo per seat** |

Yearly Pro is ~42% off vs monthly.
